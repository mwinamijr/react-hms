...
// assets
import { RightOutlined } from "@ant-design/icons"; // Replacing Tabler IconTallymark1
...
const Breadcrumbs = ({
  ...
  // ✅ Memoize getCollapse to avoid unnecessary re-creations
  ...
  }, [navigation, getCollapse]); // ✅ Now includes getCollapse in dependencies
